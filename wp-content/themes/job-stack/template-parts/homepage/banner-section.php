                        ...
                        <div class="search-filter-wrap">
                          ...
                          <div class="filter-inputwrap">
                            <div class="form-group">
                              <label class="sr-only" for="search_keywords"><?php _e('Job Titles, Keywords, Phrase','job-stack'); ?></label>
                              <input type="text" name="search_keywords" class="form-control" id="search-keywords" placeholder="<?php esc_attr_e( 'Job Titles, Keywords, Phrase', 'job-stack' ); ?>">
                            </div>
                            
                            <?php if($job_region == '1') : ?>
                              <?php if ( ! empty( $regions ) && ! is_wp_error( $regions ) ) :?>
                                <div class="form-group">
                                  <label class="sr-only" for="search_region"><?php _e('Job Region','job-stack') ?></label>
                                  <select class="form-control" id="job-region" name="search_region"  >
                                    <option><?php _e('All Regions' ,'job-stack') ?></option>
                                    <?php 
                            ...
                            <?php else: ?>
                            <div class="form-group">
                              <label class="sr-only" for="search_location"><?php _e('All Location','job-stack') ?></label>
